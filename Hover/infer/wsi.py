...
class InferManager(base.InferManager):
    ...
    def process_single_file(self, wsi_path, msk_path, output_dir):
        ...
        path_split = path_split if path_split.exists() else None  #--presplit_dir=/home/xujun/FUSCC/WSI_example/WSI_presplit2
        print(path_split)
        #path_split = None
        ...
        # msk_path = '/mnt/data/sc_MTOP-master/9.4/mask/Example001.png'
